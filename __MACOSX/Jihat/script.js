...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // Basic validation
        if (!name || !phone) {
            alert('Lütfen adınızı, soyadınızı ve telefon numaranızı giriniz.');
            return;
        }
...
Tarih: ${new Date().toLocaleString('tr-TR')}
        ...
        // Success message
        setTimeout(() => {
            alert('E-posta istemciniz açıldı. Mesajınızı göndermek için e-posta istemcinizden "Gönder" butonuna tıklayın.');
