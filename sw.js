...
const CACHE_NAME = 'dcteknik-v1.11.2-button-fix';
const STATIC_CACHE = 'dcteknik-static-v1.11.2';
const DYNAMIC_CACHE = 'dcteknik-dynamic-v1.11.2';
const IMAGE_CACHE = 'dcteknik-images-v1.11.2';
